          ...
          <div className="container grid-layout">
            ...
            <div class="sobre-skills">
                ...
                <div class="timeline">
                    ...
                    <div class="timeline-item active-item">
                        <div class="timeline-dot"></div>
        ...
        <div class="container">
            <div class="habilidades-container">
                ...
                <div class="skill-group">
                    <span class="skill-label">Desenvolvimento Full-Stack</span>
                ...
                <div class="skill-group">
                    <span class="skill-label">Dados, Infra e Gestão Digital</span>
                    <div class="tags-skills">
        ...
        <section id="contato" className="sessao-conteudo bg-light">
          <div className="container contato">
            ...
            <div className="botoes-contato">
			  ...
			  <a href="https://www.instagram.com/rahy_tavares?igsh=MWVxbHcxZHkxdTFtNg==" target="_blank" class="btn-social btn-instagram">Instagram</a>
            </div>
          </div>
        </section>
      </main>
