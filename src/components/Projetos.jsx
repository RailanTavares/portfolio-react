                        ...
                        <div className="card-projeto" key={index}>
                            ...
                            <div className="tags-projeto" style={{ marginBottom: "15px" }}>
                                {projeto.tags.map((tag, tagIndex) => (
                                    <span 
                                        key={tagIndex} 
                                        style={{ background: "#eff6ff", padding: "4px 8px", borderRadius: "4px", fontSize: "0.8rem", marginRight: "5px" }}
                                    >
                                        {tag}
                                    </span>
                                ))}
                            ...
                            <a href={projeto.link} target="_blank" rel="noopener noreferrer" className="btn-link">Ver Repositório →</a>
                        </div>
                    ))}
                </div>
            </div>
